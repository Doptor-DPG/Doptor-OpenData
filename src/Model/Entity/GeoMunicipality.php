 ...
 * @property string $municipality_name_eng
 * @property string $municipality_name_bng
 ...
 */
class GeoMunicipality extends Entity
{
    /**
    ...
    protected $_accessible = [
        ...
        'municipality_name_eng' => true,
        'municipality_name_bng' => true,
        'bbs_code' => true,
        'status' => true,
        'created_by' => true,
        'modified_by' => true,
