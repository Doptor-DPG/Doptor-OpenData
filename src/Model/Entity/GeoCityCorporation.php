 ...
 * @property string $city_corporation_name_eng
 * @property string $city_corporation_name_bng
 ...
 */
class GeoCityCorporation extends Entity
{
    /**
    ...
    protected $_accessible = [
        ...
        'city_corporation_name_eng' => true,
        'city_corporation_name_bng' => true,
        'bbs_code' => true,
        'status' => true,
        'created_by' => true,
        'modified_by' => true,
