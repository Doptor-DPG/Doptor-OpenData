    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="text-primary"><strong>Privacy Policy for Doptor Organogram Data Platform</strong></h3>
                <hr>

                <h6><strong>Data Handling Policy:</strong></h6>
                <p class="text-reset">
                    • The Doptor Organogram Data platform follows strict guidelines for handling user data to ensure privacy and security.
                    <br>
                ...
                <h6><strong>Personally Identifiable Information (PII) Data Collection and Distribution Policy:</strong></h6>
                <p class="text-reset">
                ...
                <h6><strong>Non-PII Data Collection and Distribution Policy:</strong></h6>
                <p class="text-reset">
                ...
                <h6><strong>License Policy:</strong></h6>
                <p class="text-reset">
                ...
                <h6><strong>Cookie Policy:</strong></h6>
                <p class="text-reset">
                ...
                <h6><strong>Authentication Policy (Security Policy):</strong></h6>
                <p class="text-reset">
                    •	The platform implements secure authentication mechanisms, such as username/password or multi-factor authentication, to verify user identities.
                    <br>
                ...
                <p class="text-reset">
                    ...
                    How Doptor Organogram Data Platform Handles Inappropriate and Illegal Content:
