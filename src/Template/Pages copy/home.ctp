...
<head>
    ...
    <style>
        body {
            background-image: url("landing-page-background-image.webp");
        }
        header{
...
<header class="row">
    <div class="header-image"><?= $this->Html->image('landing-page-image.png') ?></div>
    <div class="header-title">
        <h1><?= (Plugin::isLoaded('DebugKit'))?('CakePHP '.Configure::version().' Red Velvet.'):'দপ্তর: দপ্তর ব্যবস্থাপনা ও সেবা কাঠামো' ?></h1>    </div>
</header>
