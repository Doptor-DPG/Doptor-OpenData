...
/**
 * GeoMunicipalitiesFixture
 */
class GeoMunicipalitiesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'municipality_name_eng' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'municipality_name_bng' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'upazila_bbs_code' => 'Lo',
                'municipality_name_eng' => 'Lorem ipsum dolor sit amet',
                'municipality_name_bng' => 'Lorem ipsum dolor sit amet',
                'bbs_code' => 'Lo',
                'status' => 1,
                'created_by' => 1,
                'modified_by' => 1,
                'created' => '2021-07-31 08:33:12',
                'modified' => '2021-07-31 08:33:12',
            ],
        ];
        parent::init();
    }
