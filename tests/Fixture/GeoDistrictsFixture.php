 ...
 * GeoDistrictsFixture
 */
class GeoDistrictsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'district_name_eng' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'district_name_bng' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'district_name_eng' => 'Lorem ipsum dolor sit amet',
                'district_name_bng' => 'Lorem ipsum dolor sit amet',
                'bbs_code' => 'Lo',
                'status' => 1,
                'created_by' => 1,
                'modified_by' => 1,
                'created' => '2019-09-01 10:42:54',
                'modified' => '2019-09-01 10:42:54'
            ],
        ];
        parent::init();
    }
