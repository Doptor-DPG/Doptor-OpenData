...
/**
 * GeoCityCorporationsFixture
 */
class GeoCityCorporationsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'city_corporation_name_eng' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'city_corporation_name_bng' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'city_corporation_name_eng' => 'Lorem ipsum dolor sit amet',
                'city_corporation_name_bng' => 'Lorem ipsum dolor sit amet',
                'bbs_code' => 'Lo',
                'status' => 1,
                'created_by' => 1,
                'modified_by' => 1,
                'created' => '2021-07-31 07:06:20',
                'modified' => '2021-07-31 07:06:20',
            ],
        ];
        parent::init();
    }
