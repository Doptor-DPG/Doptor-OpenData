 ...
 * GeoThanasFixture
 */
class GeoThanasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'thana_name_eng' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'thana_name_bng' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'thana_name_eng' => 'Lorem ipsum dolor sit amet',
                'thana_name_bng' => 'Lorem ipsum dolor sit amet',
                'bbs_code' => 'Lo',
                'status' => 1,
                'created_by' => 1,
                'modified_by' => 1,
                'created' => '2021-07-31 08:36:50',
                'modified' => '2021-07-31 08:36:50',
            ],
        ];
        parent::init();
    }
